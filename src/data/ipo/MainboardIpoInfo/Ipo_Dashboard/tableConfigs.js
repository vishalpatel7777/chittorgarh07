export const TABLE_CONFIGS = {
  mainboard: [
    {
      ...
      columns: [
        ...
        { key: "issueDate", label: "Issue Date", align: "right" }
      ],
    ...
    },
    {
      ...
      subtitle: "Track daily IPO performance of recent and past mainboard IPOs.",
      columns: [
        { key: "company", label: "Company", link: true },
  ...
  columns: [
    { key: "company", label: "Basis of Allotments", link: true },
  ],
},
{
  id: "eventCalendar",
