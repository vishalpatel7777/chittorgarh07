...
import UpcomingIpoTable from "@components/ipo/MainboardIpoInfo/UpcomingIpos/UpcomingIpoTable";
import { UpcomingIpoData } from "@data/ipo/MainboardIpoInfo/UpcomingIpos/UpcomingIpoData";

export const ReitsIpos = () => {
  const [ipos] = useState(UpcomingIpoData);

  return (
    <main className="mx-auto max-w-7xl p-4">
      {/* Upcoming IPO Table */}
      <UpcomingIpoTable data={ipos} />
