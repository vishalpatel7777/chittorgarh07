    ...
    <section className="w-full border-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center my-4 gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className="border border-green-600 text-green-700 text-sm px-3 py-1 rounded flex items-center gap-2 hover:bg-green-50 transition"
            title="Export to CSV"
          >
...
export default IpoAllotmentStatusTable;
