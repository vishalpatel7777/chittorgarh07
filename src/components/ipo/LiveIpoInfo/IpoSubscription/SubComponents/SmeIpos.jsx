  ...
  return (
    <>
      ...
      <div className="bg-white  rounded-lg p-3 shadow-sm flex flex-col md:flex-row gap-4">
        <img
          src="https://www.chittorgarh.net/images/ipo/report_sme-ipo-subscription-status-live-bidding-bse-nse_22.png"
          alt="SME IPO Subscription Status"
          className="w-[300px] h-auto rounded shadow-sm"
        />

        <div className="text-sm text-gray-700">
          <p className="mb-2">
            This report provides live SME IPO subscription data with details
            on total issue size and category-wise demand.
          </p>
